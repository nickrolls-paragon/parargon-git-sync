...
type IAirtableIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, IAirtableIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for airtable
 */
export type IAirtableIntegration = {
  /**
   * name of integration
   */
  name: string;
