...
type IPowerbiIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, IPowerbiIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for powerbi
 */
export type IPowerbiIntegration = {
  /**
   * name of integration
   */
  name: string;
