...
type IPagerdutyIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, IPagerdutyIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for pagerduty
 */
export type IPagerdutyIntegration = {
  /**
   * name of integration
   */
  name: string;
