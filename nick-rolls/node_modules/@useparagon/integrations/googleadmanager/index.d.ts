...
type IGoogleadmanagerIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, IGoogleadmanagerIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for googleadmanager
 */
export type IGoogleadmanagerIntegration = {
  /**
   * name of integration
   */
  name: string;
