...
type IMixpanelIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, IMixpanelIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for mixpanel
 */
export type IMixpanelIntegration = {
  /**
   * name of integration
   */
  name: string;
