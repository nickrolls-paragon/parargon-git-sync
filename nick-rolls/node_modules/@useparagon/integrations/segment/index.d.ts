...
type ISegmentIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, ISegmentIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for segment
 */
export type ISegmentIntegration = {
  /**
   * name of integration
   */
  name: string;
