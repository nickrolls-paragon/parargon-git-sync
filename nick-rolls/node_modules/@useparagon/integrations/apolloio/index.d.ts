...
type IApolloioIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, IApolloioIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for apolloio
 */
export type IApolloioIntegration = {
  /**
   * name of integration
   */
  name: string;
