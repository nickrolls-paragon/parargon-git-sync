...
type IUnleashedIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, IUnleashedIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for unleashed
 */
export type IUnleashedIntegration = {
  /**
   * name of integration
   */
  name: string;
