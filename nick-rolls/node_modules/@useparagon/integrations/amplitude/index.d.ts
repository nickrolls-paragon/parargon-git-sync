...
type IAmplitudeIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, IAmplitudeIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for amplitude
 */
export type IAmplitudeIntegration = {
  /**
   * name of integration
   */
  name: string;
