...
type ISageaccountingIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, ISageaccountingIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for sageaccounting
 */
export type ISageaccountingIntegration = {
  /**
   * name of integration
   */
  name: string;
