...
type IVantaIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, IVantaIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for vanta
 */
export type IVantaIntegration = {
  /**
   * name of integration
   */
  name: string;
