...
type ISheinIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, ISheinIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for shein
 */
export type ISheinIntegration = {
  /**
   * name of integration
   */
  name: string;
