...
type IMicrosoftExcelIntegrationUserDefinedInput = {
  id: string;
  title: string;
  required?: boolean;
  tooltip?: string;
...
export declare const createInputs: <
  T extends Record<string, IMicrosoftExcelIntegrationUserDefinedInput>,
>(
  inputs: T,
) => T;

/**
 * integration type for microsoftExcel
 */
export type IMicrosoftExcelIntegration = {
  /**
   * name of integration
   */
  name: string;
