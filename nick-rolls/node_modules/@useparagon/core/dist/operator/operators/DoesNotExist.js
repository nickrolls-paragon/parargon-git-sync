...
function DoesNotExist(variable) {
    return (dependencies) => {
        const variableAsSource = (0, resolver_utils_1.resolveToSource)(variable, resolvers_interface_1.DataType.ANY, dependencies);
        return {
            operator: resolvers_interface_1.Operator.DoesNotExist,
            variable: variableAsSource,
        };
    };
}
exports.default = DoesNotExist;
//# sourceMappingURL=DoesNotExist.js.map