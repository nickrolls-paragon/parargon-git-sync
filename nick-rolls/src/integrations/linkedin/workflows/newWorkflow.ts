...
import {
  createInputs,
  ILinkedinIntegration,
  InputResultMap,
} from '@useparagon/integrations/linkedin';
...
> {
   ...
   */
  define(
    integration: ILinkedinIntegration,
    context: IContext<InputResultMap>,
    connectUser: IConnectUser<IPersona<typeof personaMeta>>,
  ) {
    const triggerStep = undefined;

    const actionStep = integration.actions.getProfileById(
      {},
      {
        autoRetry: false,
   ...
   */
  readonly id: string = '32f4a9ef-219b-47f1-9615-bc221dec8420';
}
