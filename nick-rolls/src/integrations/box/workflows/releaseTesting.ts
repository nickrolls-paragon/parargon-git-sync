...
/**
 * Release testing Workflow implementation
 */
...
> {
  ...
  define(
    ...
    const actionStep = integration.actions.listFiles(
   ...
   */
  readonly id: string = 'ec80496b-a532-4740-8f0e-bb58b28b1338';
}
