...
import {
  ...
  IGongIntegration,
  InputResultMap,
} from '@useparagon/integrations/gong';
...
> {
  ...
  define(
    ...
    const actionStep = integration.actions.getCallById(
      { id: `${triggerStep.output.request.body}` },
      {
        autoRetry: false,
   ...
   */
  readonly id: string = '4a63cd86-195c-4713-84aa-706a66685671';
}
