...
import {
  createInputs,
  IFacebookAdsIntegration,
  InputResultMap,
} from '@useparagon/integrations/facebookAds';
...
> {
   ...
   */
  define(
    integration: IFacebookAdsIntegration,
   ...
   */
  readonly id: string = 'f3244376-0bd6-4e98-ae71-7f3a6a5dca62';
}
