...
import {
  createInputs,
  IMondayComIntegration,
  InputResultMap,
} from '@useparagon/integrations/monday.com';
...
> {
   ...
   */
  define(
    integration: IMondayComIntegration,
    ...
    const actionStep = integration.actions.mondayCreateItem(
      { name: ``, boardId: `` },
      {
        autoRetry: false,
   ...
   */
  readonly id: string = '83b7f853-6d71-4536-832a-bec9b9f33aa6';
}
