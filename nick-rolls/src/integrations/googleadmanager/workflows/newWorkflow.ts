...
import {
  createInputs,
  IGoogleadmanagerIntegration,
  InputResultMap,
} from '@useparagon/integrations/googleadmanager';
...
> {
   ...
   */
  define(
    integration: IGoogleadmanagerIntegration,
    ...
    const integrationRequestStep = new IntegrationRequestStep({
      ...
      params: {},
      headers: {},
      body: `<getLineItemsByStatement xmlns="https://www.google.com/apis/ads/publisher/v202408">
    <filterStatement/>
   ...
   */
  readonly id: string = 'bd01ce38-e2ac-4999-8169-d54f4ae52bc8';
}
