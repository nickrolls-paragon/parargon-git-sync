...
import {
  createInputs,
  IConfluenceIntegration,
  InputResultMap,
} from '@useparagon/integrations/confluence';
...
> {
   ...
   */
  define(
    integration: IConfluenceIntegration,
    context: IContext<InputResultMap>,
    connectUser: IConnectUser<IPersona<typeof personaMeta>>,
  ) {
    const triggerStep = new UnselectedStep();

    const actionStep = integration.actions.createPage(
      {},
      {
        autoRetry: false,
   ...
   */
  readonly id: string = 'c0c28afe-0bcd-4850-8d9e-89b6fa992229';
}
