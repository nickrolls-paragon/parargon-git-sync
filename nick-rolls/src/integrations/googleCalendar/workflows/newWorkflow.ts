...
> {
  ...
  define(
    ...
    const triggerStep =
      integration.triggers.googleCalendarWebhookTriggerEventCreated({
        collapseRecurringEventUpdates: false,
        calendarId: `${connectUser.providerId}`,
      });

    const actionStep = integration.actions.googleCalendarUpdateEvent(
      { eventLocation: `` },
      {
        autoRetry: false,
   ...
   */
  readonly id: string = '9c83d996-a221-4ad2-8507-d1e130076221';
}
