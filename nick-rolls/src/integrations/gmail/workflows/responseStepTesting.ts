...
/**
 * Response Step Testing Workflow implementation
 */
...
> {
  ...
  define(
    ...
    const responseStep = new ResponseStep({
      ...
      responseType: 'JSON',
      body: {
        executionId: 'This would be a variable value',
        paragon: connectUser.userId,
      },
    });
    ...
    const testMessageStep = integration.actions.sendEmail(
      {
        toRecipients: `"nick@rollsfamily.me"`,
   ...
   */
  name: string = 'Response Step Testing';
   ...
   */
  readonly id: string = '39f602c3-aeb5-4e5a-a06a-015d7d1efd7e';
}
