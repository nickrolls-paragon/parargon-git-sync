...
/**
 * Integration Enabled - Multi auth testing Workflow implementation
 */
...
> {
  ...
  define(
    ...
    const requestStep = new RequestStep({
      ...
      params: {},
      headers: {},
      body: { who: `${connectUser.providerId}`, ingegrationEnabled: `yes` },
      bodyType: 'json',
    });
   ...
   */
  name: string = 'Integration Enabled - Multi auth testing';
   ...
   */
  readonly id: string = '68e47da0-a9b1-4a40-bee0-cb6a921a5401';
}
