...
/**
 * Empty Workflow Workflow implementation
 */
...
> {
  ...
  define(
    ...
    const actionStep = integration.actions.searchForEmail(
      {
        emailFilterFormula: Operators.StringContains(
          'from',
          'gatlin.hebert@useparagon.com',
        ),
      },
      {
        autoRetry: false,
        continueWorkflowOnError: false,
        description: 'Search for Gatlin',
      },
    );
   ...
   */
  readonly id: string = '5ebed725-d2fe-4230-852f-30993e099d1f';
}
