...
/**
 * PR created Workflow implementation
 */
...
> {
  ...
  define(
    ...
    const triggerStep = integration.triggers.pullRequestCreated({
      apiType: 'githubApp',
    });
   ...
   */
  readonly id: string = 'bd04ce98-29b3-49a1-9069-6ce5770cc81a';
}
