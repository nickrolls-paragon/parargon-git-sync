...
import {
  ...
  InputResultMap,
  IShopifyIntegration,
} from '@useparagon/integrations/shopify';
...
> {
   ...
   */
  define(
    integration: IShopifyIntegration,
    context: IContext<InputResultMap>,
    connectUser: IConnectUser<IPersona<typeof personaMeta>>,
  ) {
    const triggerStep = undefined;

    const actionStep = integration.actions.getProducts(
      {},
      {
        autoRetry: false,
   ...
   */
  readonly id: string = '9c066fa6-8392-45b6-8694-68c3c6822c17';
}
