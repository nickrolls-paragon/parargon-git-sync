...
import {
  ...
  InputResultMap,
  IOutlookIntegration,
} from '@useparagon/integrations/outlook';
...
> {
   ...
   */
  define(
    integration: IOutlookIntegration,
    context: IContext<InputResultMap>,
    connectUser: IConnectUser<IPersona<typeof personaMeta>>,
  ) {
    const triggerStep = integration.triggers.eventCreatedWebhook({});
   ...
   */
  readonly id: string = '23cb3272-5d59-4500-bad2-ae98e7ba9dec';
}
