...
/**
 * Dynamic Field Maps and Update Records Logic Workflow implementation
 */
...
> {
  ...
  define(
    ...
    const createContactStep = integration.actions.createRecord(
      {
        recordType: 'contacts',
        'field-email': `${triggerStep.output.mappedIntegrationObject.fields.email}`,
        'field-firstname': `${triggerStep.output.mappedIntegrationObject.fields.firstname}`,
        'field-lastname': `${triggerStep.output.mappedIntegrationObject.fields.lastname}`,
        'field-jobtitle': `${triggerStep.output.mappedIntegrationObject.fields.jobtitle}`,
   ...
   */
  name: string = 'Dynamic Field Maps and Update Records Logic';
  ...
  inputs = createInputs({
    dynamic_maps: {
      id: 'ec1ea419-d19a-4c3b-a9d4-a823a857eb6e',
      title: 'Dynamic Maps',
      tooltip: '',
      required: false,
      type: 'field_mapping',
      useDynamicMapper: true,
      dynamicObjectName: 'exampleMapping',
   ...
   */
  readonly id: string = 'b5d4585c-7847-49ec-82c2-e3f98eb4d81c';
}
