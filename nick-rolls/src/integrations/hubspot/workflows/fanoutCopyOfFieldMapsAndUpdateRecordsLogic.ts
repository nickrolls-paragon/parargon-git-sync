...
/**
 * Fanout Copy of Field Maps and Update Records Logic Workflow implementation
 */
...
> {
  ...
  define(
    ...
    const mapStep = new FanOutStep({
      description: 'Fanout over Contacts',
      iterator: [],
    });
...
"hs_calculated_phone_number": +16168190094"
`,
      },
      {
        autoRetry: false,
   ...
   */
  name: string = 'Fanout Copy of Field Maps and Update Records Logic';
   ...
   */
  readonly id: string = 'b106533a-7929-4ada-86d7-a5ed5654ad3b';
}
