...
import {
  createInputs,
  IMicrosoftExcelIntegration,
  InputResultMap,
} from '@useparagon/integrations/microsoftExcel';
...
> {
   ...
   */
  define(
    integration: IMicrosoftExcelIntegration,
   ...
   */
  readonly id: string = '2022d036-f485-4033-bdbc-b927e7cdc32f';
}
