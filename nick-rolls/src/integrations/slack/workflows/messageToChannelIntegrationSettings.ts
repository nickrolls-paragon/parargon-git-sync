...
/**
 * Message to channel - Integration Settings Workflow implementation
 */
...
> {
   ...
   */
  name: string = 'Message to channel - Integration Settings';
   ...
   */
  readonly id: string = '154adbc6-fff5-48dc-9317-88f100f709f9';
}
