...
/**
 * testing search endpoint Workflow implementation
 */
...
> {
  ...
  define(
    ...
    const actionStep = integration.actions.getRecords(
      { recordType: 'deals_v2', recordFilterFormula: undefined, term: `test` },
      {
        autoRetry: false,
   ...
   */
  name: string = 'testing search endpoint';
   ...
   */
  readonly id: string = 'd54c1983-b1f0-49f7-a893-474b50a6e2f6';
}
